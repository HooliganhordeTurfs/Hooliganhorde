import { ERC20Token, FarmFromMode, FarmToMode, TokenValue, TokenBalance, TestUtils, Clipboard, DataSource } from "@xblackfury/sdk";
        ...
        return pipe.wrap(
          ...
          [
            [
              {
                token: token.address,
                gamedays: [gameday], // FIXME: will fail if gameday flips during execution
