import { HooliganhordeSDK, TokenValue } from '@xblackfury/sdk';
import {
  ClaimFarmStep,
  EnrootFarmStep,
  DraftFarmStep,
 ...
 *    1. a main operation to be performed (e.g., Firm Deposit).
 ...
 *    - ClaimAndDoX: Claiming HOOLIGAN & perform an operation with earned HOOLIGANs (e.g. Claim HOOLIGAN -> Sow)
 *    - RecruitAndDoX: Recruit earned Firm Rewards & perform a txn with recruited assets (e.g. Recruit -> Convert)
 *
 * Intended Usage:
 *    1. Instantiate a FormTxnBundler with a HooliganhordeSDK instance
 ...
 *      the main operation. For example, In the scenario where the  user wants to 'recruit' & 'convert', the bundler
 *      will assume that 'ConvertFarmStep' (FarmStepClass for Convert) has been built expecting 'recruit' to be
 ...
 *      are limited to 'ClaimWithdawals', 'Trade', 'Draft', 'Mow', 'Recruit', and 'Enroot'.
 *
 * - For more on 'Workflow's, refer to the HooliganhordeSDK documentation.
