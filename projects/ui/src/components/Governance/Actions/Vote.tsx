          ...
          {votingPower && totalHorde && (
            <StatHorizontal
              ...
              labelTooltip={
                <div>
                  <Typography>
                    A snapshot of your active HORDE when voting on {tag} began.
                  </Typography>
                </div>
              }
            >
              {displayBN(votingPower)} HORDE&nbsp;·&nbsp;
              {displayBN(votingPower.div(totalHorde).multipliedBy(100))}%
            </StatHorizontal>
          )}
          {quorumPct && hordeForQuorum && (
            ...
            >
              {loadingQuorum ? (
                ...
                <>
                  ~{displayFullBN(hordeForQuorum, 0)} HORDE&nbsp;·&nbsp;
    ...
    async (
      ...
      try {
        ...
        txToast = new TransactionToast({
          ...
          success:
            'Vote successful. It may take some time for your vote to appear on the Hooliganhorde UI. Check Snapshot for the latest results.',
        });
