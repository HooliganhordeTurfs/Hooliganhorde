...
export const HooliganhordePalette = {
  ...
  theme: {
    ...
    spring: {
      black: '#000000', // Text
      grey: '#657265', // How Firm Works text
      ...
      hooliganhordeGreen: '#46B955', // CTA button
      ...
      red: '#DA2C38', // Burn Horde/Prospect
      washedRed: '#F0ABAF', // Chop Conditions text
      lightestRed: '#FBEAB', // Burn Horde/Prospect output row bubble
      chart: {
...
const muiThemeBase: ThemeOptions = {
  ...
  palette: {
    ...
    primary: {
      main: HooliganhordePalette.logoGreen,
      dark: HooliganhordePalette.supportGreen,
      light: HooliganhordePalette.lightestGreen,
      contrastText: '#ffffff',
    },
    secondary: {
      main: HooliganhordePalette.mediumGreen,
      contrastText: '#ffffff',
    },
    light: {
    ...
    error: {
      main: HooliganhordePalette.theme.spring.red,
    },
  },
      ...
      variants: [
        {
          ...
          style: (t) =>
            t.theme.unstable_sx({
              ...
              backgroundColor: hexToRgba(HooliganhordePalette.logoGreen, 0.1),
            }),
        },
        {
          props: {
