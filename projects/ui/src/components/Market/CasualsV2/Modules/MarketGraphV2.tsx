        ...
        >
          <Stack width="100%" gap={0.5}>
            <Row justifyContent="space-between">
              <Typography variant="body1">price per casual</Typography>
              <Typography variant="body1">
                {displayBN(selectedOrder.pricePerCasual)}
              </Typography>
            </Row>
            <Row justifyContent="space-between">
            ...
            <Row justifyContent="space-between">
              ...
              <Typography variant="body1">
                {displayBN(selectedOrder.casualAmountRemaining)}
              </Typography>
            </Row>
          </Stack>
        </Button>
              ...
              >
                <Stack width="100%" gap={0.5}>
                  <Row justifyContent="space-between">
                    <Typography variant="body1">price per casual</Typography>
                    <Typography variant="body1">
                      {displayBN(order.pricePerCasual)}
                    </Typography>
                  </Row>
                  <Row justifyContent="space-between">
                    <Typography variant="body1">max place in line</Typography>
                  ...
                  <Row justifyContent="space-between">
                    <Typography variant="body1">amount</Typography>
                    <Typography variant="body1">
                      {displayBN(order.casualAmountRemaining)}
                    </Typography>
                  </Row>
                </Stack>
              </Button>
