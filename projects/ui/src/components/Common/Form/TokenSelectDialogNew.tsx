...
import { ApplicableBalance, GuvnorBalances } from '~/state/guvnor/balances';
...
export type TokenSelectDialogProps<K extends keyof TokenBalanceMode> = {
  ...
  // balances: GuvnorFirmBalance['deposited'] | GuvnorBalances | undefined;
  ...
  ({
    ...
    const getBalance = useCallback(
      (addr: string) => {
        ...
        return (
          (_balances as TokenBalanceMode['firm-deposits'])?.[addr]?.deposited
            ?.amount || ZERO_BN
        );
      },
          ...
          <List sx={{ p: 0 }}>
            ...
            {_balances ? (
              ...
              >
                ...
                <Link
                  href="https://docs.hooligan.black/almanac/protocol/asset-states"
                  target="_blank"
                  rel="noreferrer"
                  underline="none"
                >
