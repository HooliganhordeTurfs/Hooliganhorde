...
import { HOOLIGAN, CRV3, DAI, USDC, USDT, WETH } from '~/constants/tokens';
      ...
      <Stack gap={1}>
        ...
        <>
          ...
          <FarmModeField
            ...
            farmDesc="Send assets to another internal balance within Hooliganhorde."
...
const SUPPORTED_TOKENS = [HOOLIGAN, WETH, CRV3, DAI, USDC, USDT];
  ...
  const onSubmit = useCallback(
    async (
      ...
      try {
        ...
        const txn = await hooliganhorde.transferToken(
          tokenAddress,
          recipient,
          amount,
          fromMode,
        ...
        await Promise.all([refetchGuvnorBalances()]);
    ...
    [account, refetchGuvnorBalances, hooliganhorde, middleware]
  );
