...
import { SwapOperation } from '@xblackfury/sdk';
import {
  FormApprovingState,
  FormTokenState,
  SettingInput,
...
import { HOOLIGAN, CRV3, DAI, ETH, USDC, USDT, WETH } from '~/constants/tokens';
...
const SUPPORTED_TOKENS = [HOOLIGAN, ETH, WETH, CRV3, DAI, USDC, USDT];
...
const Swap: FC<{}> = () => {
  ...
  const initialValues: SwapFormValues = useMemo(
    ...
    [Hooligan, Eth, account, sdk.swap, sdk.tokens]
  );
  ...
  const onSubmit = useCallback(
    ...
    [account, refetchGuvnorBalances, middleware]
  );
