...
export default abstract class Pool {
   ...
   * e.g. if a guvnor deposits amount1 of Hooligans and amount2 of Eth into an LP pool with reserve1 Hooligans, reserve2 Eth and totalLP LP tokens, it returns how many LP tokens the guvnor gets.
   */
  static lpForPool = (
    amount1: BigNumber,
    reserve1: BigNumber,
