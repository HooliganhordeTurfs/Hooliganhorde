...
import MarketActions from '~/components/Market/CasualsV2/Modules/MarketActions';
import MarketActivityTable from '~/components/Market/CasualsV2/Modules/MarketTables';
import MarketGraphContainer from '~/components/Market/CasualsV2/Modules/MarketGraphContainer';
import { muiThemeCondensed } from '~/components/App/muiTheme';
import { marketBottomTabsHeightAtom } from '~/components/Market/CasualsV2/info/atom-context';
...
const CasualMarketV2: React.FC<{}> = () => (
  <ThemeProvider theme={muiThemeCondensed}>
    <MarketPage />
  </ThemeProvider>
);

export default CasualMarketV2;
