...
const GuvnorDelegatePage: React.FC<{}> = () => {
  ...
  const isNFT = govSlug === GovSpace.HooliganNFT;
          ...
          <Stack p={2} gap={2}>
            <Stack gap={1}>
              ...
              <Typography color="text.secondary">
                Delegate your {isNFT ? 'HooligaNFT' : 'Horde'} votes on&nbsp;
...
export default GuvnorDelegatePage;
