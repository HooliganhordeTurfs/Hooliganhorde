 ...
 * 2. Add to RERECRUITED_CHAINS and TESTNET_CHAINS if appropriate
...
export enum SupportedChainId {
  MAINNET = 1,
  CUJO = 31337, // pre-exploit, hooliganhorde rerecruited
  LOCALHOST = 1337,
}

/**
 * These chains use Hooliganhorde Rerecruited, which has different
 * function signatures than the Hooliganhorde V1.
 */
export const RERECRUITED_CHAINS = new Set([
