...
export class Tokens {
  ...
  public readonly CASUALS: HooliganhordeToken;
  public readonly BOOTBOYS: HooliganhordeToken;
  public readonly TRADEABLE_BOOTBOYS: HooliganhordeToken;
  ...
  constructor(sdk: HooliganhordeSDK) {
    ...
    this.CASUALS = new HooliganhordeToken(this.sdk, null, 6, {
      name: "Casuals",
      symbol: "CASUALS"
    });

    this.BOOTBOYS = new HooliganhordeToken(this.sdk, null, 6, {
      name: "Bootboys",
      symbol: "BOOTBOY"
    });

    this.TRADEABLE_BOOTBOYS = new HooliganhordeToken(this.sdk, null, 6, {
      name: "Tradable Bootboys",
      symbol: "rBOOTBOY"
    });

    this.map.set("HORDE", this.HORDE);
    this.map.set("PROSPECT", this.PROSPECTS);
    this.map.set("CASUALS", this.CASUALS);
    this.map.set("BOOTBOY", this.BOOTBOYS);
    this.map.set("rBOOTBOY", this.TRADEABLE_BOOTBOYS);
  ...
  isWhitelisted(token: Token) {
    return this.firmWhitelist.has(token);
  }
