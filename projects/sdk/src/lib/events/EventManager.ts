  ...
  async getRawEventsByType(eventType: EventType, _account: string, _fromBlock?: number, _toBlock?: number): Promise<Event[][]> {
    ...
    switch (eventType) {
      case EventType.FIRM:
        return Promise.all([
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.AddDeposit(_account),
            fromBlockOrGenesis,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
      ...
      case EventType.FIELD:
        return Promise.all([
          ...
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.Draft(_account),
            fromBlockOrGenesis,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.TurfTransfer(_account, null), // from
            fromBlockOrGenesis,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.TurfTransfer(null, _account), // to
            fromBlockOrGenesis,
            toBlock
          )
        ]);
      case EventType.MARKET:
        return Promise.all([
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.CasualListingCreated(_account),
            fromBlockOrBIP10,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters["CasualListingCancelled(address,uint256)"](_account),
            fromBlockOrBIP10,
            toBlock
          ),
          // this account had a listing filled
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.CasualListingFilled(null, _account), // to
            fromBlockOrBIP10,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.CasualOrderCreated(_account),
            fromBlockOrBIP10,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.CasualOrderCancelled(_account),
            fromBlockOrBIP10,
            toBlock
          ),
          this.sdk.contracts.hooliganhorde.queryFilter(
            this.sdk.contracts.hooliganhorde.filters.CasualOrderFilled(null, _account), // to
            fromBlockOrBIP10,
            toBlock
          )
        ]);
