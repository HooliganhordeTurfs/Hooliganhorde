...
export class LibraryPresets {
  ...
  public readonly usdc2hooligan: ActionBuilder;
  public readonly hooligan2usdc: ActionBuilder;

  public readonly dai2hooligan: ActionBuilder;
  public readonly hooligan2dai: ActionBuilder;
  ...
  constructor(sdk: HooliganhordeSDK) {
    ...
    ///////// USDC <> HOOLIGAN ///////////
    this.usdc2hooligan = (fromMode?: FarmFromMode, toMode?: FarmToMode) =>
      new ExchangeUnderlying(sdk.contracts.curve.pools.hooliganCrv3.address, sdk.tokens.USDC, sdk.tokens.HOOLIGAN, fromMode, toMode);

    this.hooligan2usdc = (fromMode?: FarmFromMode, toMode?: FarmToMode) =>
      new ExchangeUnderlying(sdk.contracts.curve.pools.hooliganCrv3.address, sdk.tokens.HOOLIGAN, sdk.tokens.USDC, fromMode, toMode);

    ///////// DAI <> HOOLIGAN ///////////
    this.dai2hooligan = (fromMode?: FarmFromMode, toMode?: FarmToMode) =>
      new ExchangeUnderlying(sdk.contracts.curve.pools.hooliganCrv3.address, sdk.tokens.DAI, sdk.tokens.HOOLIGAN, fromMode, toMode);

    this.hooligan2dai = (fromMode?: FarmFromMode, toMode?: FarmToMode) =>
      new ExchangeUnderlying(sdk.contracts.curve.pools.hooliganCrv3.address, sdk.tokens.HOOLIGAN, sdk.tokens.DAI, fromMode, toMode);
