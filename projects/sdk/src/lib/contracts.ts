...
export class Contracts {
  ...
  constructor(sdk: HooliganhordeSDK) {
    ...
    this.percoceter = HooliganhordePercoceter__factory.connect(hooliganhordePercoceterAddress, sdk.providerOrSigner);

    this.pipeline = Pipeline__factory.connect(pipelineAddress, sdk.providerOrSigner);
    this.clubhouse = Clubhouse__factory.connect(clubhouseAddress, sdk.providerOrSigner);
