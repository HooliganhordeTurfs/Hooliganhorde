...
contract InitBip12 {
    ...
    address private constant HOOLIGAN_3CURVE_ADDRESS = address(0x3a70DfA7d2262988064A2D051dd47521E43c9BdD);
    bytes4 private constant SELECTOR = bytes4(0xf984019b);
    uint32 private constant HORDE = 10000;
    uint32 private constant PROSPECTS = 4;

    function init() external {
        IBS(address(this)).whitelistToken(HOOLIGAN_3CURVE_ADDRESS, SELECTOR, HORDE, PROSPECTS);
