 ...
 * @notice Perform multiple Hooliganhorde functions calls in a single transaction using Farm calls. 
 * Any function stored in Hooliganhorde's EIP-2535 DiamondStorage can be called as a Farm call. (https://eips.ethereum.org/EIPS/eip-2535)
 **/
...
contract FarmFacet {
    ...
    **/
    ...
    // delegatecall a Hooliganhorde function using calldata data
    ...
    // delegatecall a Hooliganhorde function using memory data
    ...
    // signals to Hooliganhorde functions that they should not refund Eth 
