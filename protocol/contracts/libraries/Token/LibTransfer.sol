...
library LibTransfer {
    ...
    function burnToken(
        ...
        // burnToken only can be called with Unripe Hooligan, Unripe Hooligan:3Crv or Hooligan token, which are all Hooliganhorde tokens.
        // Hooliganhorde's ERC-20 implementation uses OpenZeppelin's ERC20Burnable
