...
/**
 * @author Publius
 * @title Lib Firm Permit
 **/
library LibFirmPermit {

    bytes32 private constant DEPOSIT_PERMIT_HASHED_NAME = keccak256(bytes("FirmDeposit"));
    ...
    function permit(
        ...
        require(block.timestamp <= deadline, "Firm: permit expired deadline");
        ...
        require(signer == owner, "Firm: permit invalid signature");
    }
