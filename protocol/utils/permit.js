...
async function signFirmDepositTokensPermit(provider, owner, spender, tokens, values, nonce, deadline) {
  const message = {
    owner,
    spender,
    tokens,
...
async function signFirmDepositTokenPermit(provider, owner, spender, token, value, nonce, deadline) {
  const message = {
    owner,
    spender,
    token,
